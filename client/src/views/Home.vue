...
import ExperienceShowcase from '../components/ExperienceTemplate.vue';
...
const projects = ref([
    ...
    },
    {
        ...
        demoUrl: 'https://fitness-website-9h3r.onrender.com/',
        technologies: [
            {
                name: 'Vue.js',
                badgeUrl: 'https://img.shields.io/badge/Vue.js-4FC08D?style=for-the-badge&logo=vue.js&logoColor=white',
...
<template>
    ...
    <div class="w-full mt-4">
      <h2 class="text-4xl font-bold mb-8 slide-in-element">{{ title }}</h2>
